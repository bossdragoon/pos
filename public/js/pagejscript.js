...
$(function () {
    $('.selectpicker')
            ...
            .selectpicker({size: 5, showIcon: true, title: ''});
     ...
     * Bootstrap Add Clear 
     ===================*/
    $(":text").not("[name*=date],.no-add-clear").addClear();
...
/*
 * getURL = retrive current url and return the root url of that controller page.
 * เพราะว่าใน javascript ใช้ตัวแปร URL ของ php ไม่ได้ เลยต้องใช้แบบนี้แทน
 */
function getURL() {
