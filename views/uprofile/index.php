    ...
    <div class="row">
        <div class="col-lg-3 col-sm-12">
            ...
            <div class="well well-sm">
                ...
                <br/>
                <button id="btn-del-pic" class="btn btn-block btn-danger"><span class="glyphicon glyphicon-trash" ></span>  ลบรูป</button>

            </div>
            <div id="kv-error-box"></div>
            <div id="kv-success-box"></div>
            ...
            <div>
                <div class="well">
                    <form id="frm-uprofile" name="frm-uprofile" action="uprofile/editByID" role="form">
                        <input type="hidden" id="person_id" name="person_id" value="<?= $logged["person_id"] ?>" />
                        <!--<input type="hidden" id="photoid" name="photoid" value="" readonly="readonly" />-->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker selectpicker-live-search" id="person_prefix" name="person_prefix">
                                <?php
